...
Shader "Character/Hair"
{
	Properties
	{
		...
		_D("D", 2D) = "white" {}
		_Cutoff( "Mask Clip Value", Float ) = 0.348
		_AO("AO", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float3 gammaToLinear208 = GammaToLinearSpace( tex2DNode12.rgb );
			...
			float3 temp_cast_3 = (( _Shift + temp_output_66_0 )).xxx;
			float3 temp_output_1_0_g23 = ( normalizeResult60 + ( temp_cast_3 * objectToTangentDir ) );
			...
			float3 temp_cast_4 = (( _Shift_2 + temp_output_66_0 )).xxx;
			float3 temp_output_1_0_g22 = ( normalizeResult60 + ( temp_cast_4 * objectToTangentDir ) );
			...
			#else
				float4 staticSwitch171 = ( _AS_Specular_Strength * saturate( ( tex2DNode12 * ( ( _SpecularColor1 * ( smoothstepResult3_g23 * ( pow( sqrt( ( 1.0 - ( dotResult18_g23 * dotResult18_g23 ) ) ) , _SpecularPower1 ) * 1.0 ) ) ) + ( ( smoothstepResult3_g22 * ( pow( sqrt( ( 1.0 - ( dotResult18_g22 * dotResult18_g22 ) ) ) , _SpecularPower2 ) * 1.0 ) ) * _SpecularColor2 ) ) ) ) );
			#endif
			o.Albedo = ( ( ( _Tint * float4( gammaToLinear208 , 0.0 ) ) + staticSwitch171 ) * tex2D( _AO, i.uv2_texcoord2 ).r ).rgb;
			o.Metallic = _Metallic;
			o.Smoothness = _Smoothness;
			float temp_output_30_0 = _SSS;
			float3 temp_cast_6 = (temp_output_30_0).xxx;
			o.Transmission = temp_cast_6;
			float3 temp_cast_7 = (temp_output_30_0).xxx;
			...
			#else
				float4 staticSwitch172 = temp_cast_8;
			#endif
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float dotResult177 = dot( ase_worldViewDir , ase_vertexNormal );
			float temp_output_179_0 = ( abs( dotResult177 ) * 1.5 );
			float4 temp_cast_10 = (temp_output_179_0).xxxx;
			float lerpResult182 = lerp( _EdgeMaskMin , 1.0 , CalculateContrast(_EdgeMaskContrast,temp_cast_10).r);
...
/*ASEBEGIN
Version=16800
0;0;1920;1029;1155.757;505.299;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;206;-4292.503,743.5088;Float;False;2983.514;1214.826;Specular;31;54;65;55;59;71;58;66;68;49;70;67;60;47;74;75;77;64;50;48;69;91;90;79;80;78;81;82;94;164;165;207;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;12;-656,0;Float;True;Property;_D;D;1;0;Create;True;0;0;False;0;None;d8cf2a3e631b70f4a85df8bb3aea2d2e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;-1776,1280;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-1837.75,1156.867;Float;False;Property;_AS_Specular_Strength;AS_Specular_Strength;12;0;Create;True;0;0;False;0;1;0.25;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-639.6062,740.8873;Float;False;Property;_AS_TexStrength;AS_TexStrength;9;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-640,480;Float;True;Property;_ASCubeMap;ASCubeMap;10;0;Create;True;0;0;False;1;;None;None;True;0;False;black;LockedToCube;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;207;-1632,1280;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GammaToLinearNode;208;-286.7571,88.70105;Float;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;160;-576,-192;Float;False;Property;_Tint;Tint;0;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleContrastOpNode;181;-1456,-192;Float;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;183;-995.0018,-759.6882;Float;False;Property;_EdgeMaskMin;EdgeMaskMin;23;0;Create;True;0;0;False;0;1.5;-28.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;159;-256,-80;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;171;-16,480;Float;False;Property;_UseHairCubeMap;UseHairCubeMap;8;0;Create;True;0;0;False;0;0;1;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;384,240;Float;False;Property;_SSS;SSS;25;0;Create;True;0;0;False;0;0.1;0.3;0;0.3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;384,144;Float;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;False;0;0.3;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;384,48;Float;False;Property;_Metallic;Metallic;6;0;Create;True;0;0;False;0;0.2;0;0;1;0;1;FLOAT;0
...
WireConnection;164;1;207;0
WireConnection;28;0;25;0
WireConnection;28;1;29;0
WireConnection;147;0;141;0
WireConnection;147;1;146;0
WireConnection;208;0;12;0
...
ASEEND*/
//CHKSM=6AD9D17F4B81A498DACFC5A6AE801FC416F5D8AB