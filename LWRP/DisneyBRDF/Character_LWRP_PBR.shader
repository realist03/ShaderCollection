...
Shader "LWRP/Character/PBR"
{
    Properties
    {
		...
		_ShadowHeight("_ShadowHeight", Float) = -0.1
    ...
    SubShader
    {
        ...
        Tags { "RenderPipeline"="LightweightPipeline" "RenderType"="Opaque" "Queue"="AlphaTest-1" }
        ...
        Pass
        {
        	...
        	struct GraphVertexOutput
            {
				...
				float4 ase_texcoord7 : TEXCOORD4;
				float3 wsViewDir				: TEXCOORD5;
                UNITY_VERTEX_INPUT_INSTANCE_ID
            ...
            GraphVertexOutput vert (GraphVertexInput v  )
        	{
				...
				o.wsViewDir = SafeNormalize( _WorldSpaceCameraPos.xyz  - float3(o.tSpace0.w,o.tSpace1.w,o.tSpace2.w) );
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float3 WorldSpaceViewDirection = IN.wsViewDir;
    
				float2 uv = IN.ase_texcoord7.xy;
				
				float4 tex2DNode5 = SAMPLE_TEXTURE2D(_M , sampler_M , uv);
				
				
		        float3 Albedo = SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv ).rgb;
				float3 Normal = UnpackNormalScale( SAMPLE_TEXTURE2D( _Normal, sampler_Normal , uv ), 1.0f );
				float3 Emission = 0;
				float3 Specular = float3(0.5, 0.5, 0.5);
				float Metallic = tex2DNode5.r;
				float Smoothness = ( 1.0 - tex2DNode5.g );
				float Occlusion = tex2DNode5.b;
				float Alpha = 1;
		...
		UsePass"Character/Shadow/Shadow"
    }
...
/*ASEBEGIN
Version=16800
-1555;168;1323;660;950.6898;107.8546;1;True;True
Node;AmplifyShaderEditor.SamplerNode;4;-486.284,-0.03756714;Float;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;None;43df43498b1c5964d92e3705bc31e680;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-492.9324,486.5889;Float;True;Property;_M;M;1;0;Create;True;0;0;False;0;None;9bfad2beb4be62143925c23ab544e1c2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;6;-178.9324,537.5889;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-485.6898,240.1454;Float;True;Property;_Normal;Normal;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;0,0;Float;False;True;2;Float;ASEMaterialInspector;0;2;LWRP/Character/PBR;1976390536c6c564abb90fe41f6ee334;True;Base;0;0;Base;11;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;Hidden/InternalErrorShader;0;0;Standard;2;Vertex Position,InvertActionOnDeselection;1;Receive Shadows;1;1;_FinalColorxAlpha;0;4;True;True;True;True;False;11;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=3929AAA7CA5F13C61E8330850B6C916B183DFC98